                ...
                <div className="max-w-7xl mx-auto px-6 w-full">
                  ...
                  >
                    ...
                    <div className="mt-6 flex flex-wrap gap-4">
                      ...
                      <Link href="/products" className="px-7 py-3.5 rounded-full bg-[#8B3A62] hover:bg-[#742e52] text-whitefont-semibold text-sm hover:shadow-xl hover:-translate-y-0.5 transition-all">
