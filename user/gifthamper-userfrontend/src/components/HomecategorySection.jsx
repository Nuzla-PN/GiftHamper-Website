...
function SectionHeader({ eyebrow, title, linkTo, inverted = false }) {
  return (
    <div className="flex items-end justify-between gap-4 mb-8 sm:mb-10">
      ...
      {linkTo && (
        <Link href={linkTo} className={`group flex items-center gap-1.5 text-xs font-semibold tracking-wide uppercase shrink-0 transition-all ${inverted ? "text-amber-300 hover:text-white" : "text-[#C2556A] hover:text-[#3B2A35]"}`}>
