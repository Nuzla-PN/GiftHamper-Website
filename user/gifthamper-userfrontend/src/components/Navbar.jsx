      ...
      <div className="hidden lg:block">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-center space-x-10 h-14">
            <Link href="/" className="text-sm font-medium text-gray-700 hover:text-[#8B3A62] transition-colors">Home</Link>
                     ...
                     className={`absolute top-full z-[1000] w-[95vw] sm:w-[520px] max-w-[95vw] sm:max-w-[520px] bg-white rounded-xl shadow-2xl border border-gray-100 p-6
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        {menu.items.map((category) => (
                          <Link key={category.title} href={category.link} className="flex items-center space-x-4 p-4 rounded-lg hover:bg-[#FFF8F6] transition-all group/item">
            ...
            <Link href="/custom-hamper" className="flex items-center space-x-1.5 text-sm font-medium text-white px-5 py-2 rounded-full transition-all hover:shadow-lg hover:scale-105" style={{ backgroundColor: '#D4AF37' }}>
        ...
        {mobileActiveDropdown === menu.name && (
          ...
          >
            <div className="grid grid-cols-2 gap-2 pb-3 px-2">
              ...
              <Link href="/account" className="w-full flex items-center justify-center space-x-2 px-6 py-3 rounded-full text-white transition-all mt-4" style={{ backgroundColor: '#8B3A62' }} onClick={() => setIsMenuOpen(false)}>
